...
{
    public class SendTransferListener
    {
        private readonly ConnectionFactory _factory;
        private readonly BankingContext _context;

        public SendTransferListener(ConnectionFactory factory, BankingContext context)
        {
            _context = context;
            _factory = factory;
        }
        ...
        public void Run()
        {
            using (var connection = _factory.CreateConnection())
            {
                ...
                {
                    channel.QueueDeclare(queue: "transfers_sent_pending", durable: false, exclusive: false, autoDelete: false, arguments: null);
